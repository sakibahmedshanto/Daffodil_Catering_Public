...
import 'package:CateringAdmin/controllers/edit-product-controller.dart';
...
void _showErrorDialog(BuildContext context, String message) {
  ...
  onPressed: () async {
    ...
    if (productModel.productImages.isEmpty) {
    ...
    try {
      ...
      print("error : $e");
      // Show error dialog
      _showErrorDialog(context, "An error occurred while updating the product. Please try again.");
    }
